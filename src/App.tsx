  ...
  <main className='flex-1 p-6 flex gap-6'>
    <div className='flex flex-col flex-1 gap-4'>
      <div className='grid grid-rows-2 gap-4 flex-1'>
        ...
        <Textarea className='resize-none p-5 leading-relaxed' placeholder='Resultado gerado pela IA...'
        readOnly/>

      </div>
      <p className='text-muted-foreground text-sm'>Lembre-se: você pode utilizar a variável <code className='text-violet-400'>{"{transcription}"}</code> no seu prompt para adicionar o conteuúdo da transcrição dovídeo selecionado.</p>
    </div>
    ...
    <Textarea id="transcription_promp" className='h-20 leading-relaxed resize-none'
    ...
    <div className='space-y-2'>
      ...
      <Select>
        ...
        <SelectContent>
          <SelectItem value="2">Título do Youtube</SelectItem>
          <SelectItem value="1">Descrição do Youtube</SelectItem>
        </SelectContent>
      </Select>
      </div>
      <div className='space-y-2'>
